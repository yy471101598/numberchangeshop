...
public class ImpObtainZhidianDcCunqi {
    public void obtainZddcCunqi(final Activity ac,String StockCode,
...
//        client.setCookieStore(myCookieStore);
        ...
        client.post(ContansUtils.BASE_URL + "pos/CoinMaturity.ashx",params, new AsyncHttpResponseHandler() {
            @Override
