...
public class ImpObtainDingcunCurrency {
    public void obtainDcCurrency(final Activity ac,
                               final InterfaceBack back) {

        AsyncHttpClient client = new AsyncHttpClient();
//        final PersistentCookieStore myCookieStore = new PersistentCookieStore(ac);
//        client.setCookieStore(myCookieStore);
        client.get(ContansUtils.BASE_URL + "pos/DepositCurrency.ashx", new AsyncHttpResponseHandler() {
            @Override
