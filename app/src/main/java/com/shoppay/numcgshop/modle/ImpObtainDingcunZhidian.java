...
public class ImpObtainDingcunZhidian {
    public void obtainDcZhidian(final Activity ac,
                               final InterfaceBack back) {

        AsyncHttpClient client = new AsyncHttpClient();
//        final PersistentCookieStore myCookieStore = new PersistentCookieStore(ac);
//        client.setCookieStore(myCookieStore);
        client.get(ContansUtils.BASE_URL + "pos/CoinDepositStockCode.ashx", new AsyncHttpResponseHandler() {
            @Override
