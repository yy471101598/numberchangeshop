...
import com.shoppay.trt.adapter.DengjiChoseAdapter;
import com.shoppay.trt.adapter.YinpianDetailAdapter;
...
public class YinpianDetailDialog {
    /**
     * 时间选择
     *
     * @param context
     ...
     */
    public static void yinpianDetailDialog(final Context context, final List<OrderDetailMsg> list,
                                         int showingLocation) {
        final Dialog dialog;
