...
public class ImpFabiDingCun {
    public void fabiDingcun(final Activity ac, final Dialog dialog, int DepositID, int UserID,String password, int CurrencyID, String Maturity, String Money,
...
//        client.setCookieStore(myCookieStore);
        ...
        client.post(ContansUtils.BASE_URL + "pos/Deposit.ashx", params, new AsyncHttpResponseHandler() {
            @Override
