...
public class ImpObtainZDDHCurrency {
    public void obtainZDDHCurrency(final Activity ac,
                               final InterfaceBack back) {

        AsyncHttpClient client = new AsyncHttpClient();
//        final PersistentCookieStore myCookieStore = new PersistentCookieStore(ac);
//        client.setCookieStore(myCookieStore);
        client.get(ContansUtils.BASE_URL + "pos/CoinExchangeStockCode.ashx", new AsyncHttpResponseHandler() {
            @Override
