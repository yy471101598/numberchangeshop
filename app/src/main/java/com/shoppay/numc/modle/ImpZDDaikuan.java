...
public class ImpZDDaikuan {
    public void zdDaikuan(final Activity ac, final Dialog dialog, int LoanID, int UserID, String password,int RateID, int StockCode, int Currency ,String MortgageCoin,
...
//            jso.put("LoginUserID",PreferenceHelper.readInt(ac, "shoppay", "userid", 0));
        ...
        client.post(ContansUtils.BASE_URL + "pos/CoinLoan.ashx", params, new AsyncHttpResponseHandler() {
            @Override
